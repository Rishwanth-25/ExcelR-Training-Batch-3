...
public class Demo021 {
    public static void main(String[] args) {
        ...
        if (taxableIncome <= 500000) {
            tax = taxableIncome * 0.10; // 10% tax on income up to Rs 500000
        } else if (taxableIncome <= 1000000) {
            tax = 50000 + (taxableIncome - 500000) * 0.20; // 20% tax on income between Rs 500000 and Rs 1000000
        } else {
            tax = 150000 + (taxableIncome - 1000000) * 0.30; // 30% tax on income above Rs 1000000
        }
